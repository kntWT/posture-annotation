...
<Paper>
    ...
    <Content>
        <List nonInteractive>
            <Item>
                <Text><strong>もとの方の位置やARマーカは無視し，耳と肩を結ぶ黄色い線が首の角度と平行になるようにマーカを調整してください</strong></Text>
            </Item>
            <Item>
                <Text>基本的には肩のみを調整すれば首の角度と平行になりますが，必要に応じて耳のマーカも調整してください</Text>
            </Item>
            <Item>
                <Text>画像の倍率は必要に応じて<span class="material-icons">remove</span><span class="material-icons">add</span>ボタンや数字を直接入力して調整してください</Text>
            </Item>
            <Item>
                <Text>
                    マーカの調整が終わったら
